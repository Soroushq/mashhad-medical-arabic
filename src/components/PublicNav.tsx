      ...
      <div className="md:hidden">
        <header className="mobile-header">
          <div className="flex justify-between items-center h-16 px-4">
            ...
            <button onClick={() => setIsOpen(!isOpen)} className="menu-toggle" aria-label="Menu">
        ...
        <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
          ...
          <nav className="sidebar-nav">
            ...
            <Link href="/admin/login" onClick={() => setIsOpen(false)} className="sidebar-admin-btn">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
              <span>دخول الإدارة</span>
        ...
        {/* Floating Bottom Nav - Dribbble Style */}
        <div className="bottom-nav">
          <div className="bottom-nav-container" data-active={activeIndex}>
